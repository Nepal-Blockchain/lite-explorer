...
`},wVDK:function(e,t,r){"use strict";r.r(t);var o=r("D57K");var n=r("ERkP");var i=r("JkUX");var a=r("tqhF");const s=a["c"].div.withConfig({displayName:"DashboardContentCenter",componentId:"sc-w4bs76"})`
    margin: 0 auto;
    width: 900px;
    max-width: 100%;
    text-align: center;
`;var l=r("6kd4");var c=r("H8JU");var p=r("DBf6");var h=r("GRjO");var d=r("f4ym");const m=Object(a["c"])("div").withConfig({displayName:"BarChartItemBarRoot",componentId:"sc-1dnjndf"})`
    height: 100%;
    box-sizing: border-box;
    ...
    opacity: .5;
    `:""}
`;const u=e=>n["createElement"](m,Object.assign({},e));const g=a["c"].div.withConfig({displayName:"BarChartItemRoot",componentId:"sc-i6i60h"})`
    cursor: pointer;
`;const f=Object(a["c"])("div").withConfig({displayName:"BarChartItemHitBox",componentId:"sc-12afr39"})`
    height: ${({maxHeight:e})=>e}px;
    padding-left: 4px;
    padding-right: 4px;
    display: flex;
    align-items: flex-end;
`;const b=Object(a["c"])("div").withConfig({displayName:"BarChartItemBarWrapper",componentId:"sc-13pugg1"})`
    width: 8px;
    height: ${e=>Math.round(e.percent*e.maxHeight/100)}px;
    min-height: 8px;
`;class x extends n["Component"]{render(){return n["createElement"](g,null,n["createElement"](h["a"],{placement:"top",nonInteractive:!0,showDelay:0,hideDelay:0,offset:10,referenceElement:()=>this.barEl,content:this.props.tooltip},n["createElement"](d["a"],{to:this.props.link},n["createElement"](f,{maxHeight:this.props.maxHeight},n["createElement"](b,{percent:this.props.value,maxHeight:this.props.maxHeight},n["createElement"](u,{active:this.props.active,innerRef:e=>this.barEl=e}))))))}}const v=Object(a["c"])("div").withConfig({displayName:"BarChartRoot",componentId:"sc-132o3lj"})`
    display: flex;
    overflow: hidden;
...
`;class C extends n["Component"]{getMaxValue(){return this.props.data.reduce((e,t)=>Math.max(e,t.value?t.value:0),0)}render(){let e=this.getMaxValue();return n["createElement"](v,{height:this.props.height,innerRef:e=>{this.props.innerRef&&this.props.innerRef(e)}},this.props.data.map((t,r)=>n["createElement"](x,{key:t.key,value:t.value?Math.floor(t.value/e*100):0,maxHeight:this.props.height,link:this.props.linkThunk?this.props.linkThunk(t):"",tooltip:this.props.tooltipThunk?this.props.tooltipThunk(t):null,active:!!this.props.activeThunk&&this.props.activeThunk(t)})))}}var y=r("/xco");var w=r("fcKJ");var E=r("sqN8");const k=50;let T=class e extends n["Component"]{constructor(){super(...arguments);this.blockValues=[];this.handleResize=(()=>{if(this.wrapperElement){this.wrapperElementWidth=this.wrapperElement.clientWidth;let e=getComputedStyle(this.wrapperElement);let t=parseInt(e.getPropertyValue("padding-left"),10)+parseInt(e.getPropertyValue("padding-right"),10);const r=this.wrapperElementWidth?Math.floor((this.wrapperElementWidth-t)/16):12;this.blocksShownCount=Math.min(r,50)}this.handleRangeChange()})}get blockRangeStart(){return(this.props.blockStateStore.getLatest()||1/0)-(this.blocksShownCount-1)}render(){return n["createElement"](C,{innerRef:e=>{this.wrapperElement=e;e&&(this.wrapperElementWidth=e.clientWidth)},height:80,data:this.blockValues.map((e,t)=>{let r;return{key:this.blockRangeStart+t,value:e?e.transactionCount:void 0,data:e}}),tooltipThunk:e=>n["createElement"]("div",{style:{padding:8,display:"flex"}},n["createElement"](y["a"],{variant:"small",noLink:!0},e.key),void 0!==e.value?n["createElement"](w["a"],{variant:"small"},this.props.translation.get("blockView.content.blockSummary.txs.label").replace(/%d/,""+e.value)):null),linkThunk:e=>this.urlBuilder.getBlock(e.key)})}componentDidMount(){this.urlBuilder=new E["a"];window.addEventListener("resize",this.handleResize);this.handleResize();this.setupLatestValueWatch()}componentWillUnmount(){window.removeEventListener("resize",this.handleResize);this.destroyLatestValueWatch()}setupLatestValueWatch(){this.destroyLatestValueWatch();this.latestValueWatch=Object(c["n"])(()=>this.props.blockStateStore.getLatest(),()=>{this.handleRangeChange()})}destroyLatestValueWatch(){if(this.latestValueWatch){this.latestValueWatch();this.latestValueWatch=void 0}}handleRangeChange(){this.dataFetchTask&&this.dataFetchTask.cancel();this.dataFetchTask=new p["a"](e=>this.fetchData(e).catch(e=>{if(!(e instanceof l["b"]))throw e}));this.dataFetchTask.start().catch(e=>this.props.logger.error(e))}fetchData(e){return o["__awaiter"](this,void 0,void 0,function*(){let t=this.blockRangeStart+this.blocksShownCount;let r=yield this.props.blockValueStore.fetch(this.blockRangeStart,t);if(e.isCancelled())return;this.blockValues=r})}};o["__decorate"]([c["l"]],T.prototype,"blocksShownCount",void 0);o["__decorate"]([c["l"].shallow],T.prototype,"blockValues",void 0);o["__decorate"]([c["e"]],T.prototype,"blockRangeStart",null);T=o["__decorate"]([i["b"]],T);var R=r("2LqZ");var B=r("zPJy");var M=r("opp1");var D=r("Unsh");var S=r("+5H0");var I=r("iTV9");var U=r("x56G");var F=r("tR7c");var $=r("Jh+e");let V=class e extends n["Component"]{constructor(){super(...arguments);this.onCheckboxChange=((e,t,r,o)=>{if(t){this.props.fields.setSelectedField(o,this.props.userPreferences);let e=this.props.fields.getSelectedField();this.props.nodeStore.selectedNode={name:e.label,url:e.value}}this.requestClose()})}render(){return n["createElement"](U["a"],{disabled:this.props.disabled,offset:{left:-20,top:-47},render:({requestClose:e})=>{this.requestClose=e;return n["createElement"](i["a"],null,()=>this.props.fields.getFields().map(e=>n["createElement"]($["a"],{id:"highlight_"+e.key,key:e.key,value:e.key,name:"highlight",checked:this.props.fields.getSelectedField().key===e.key,onChange:this.onCheckboxChange},e.label)))}},n["createElement"](F["a"],{disabled:this.props.disabled},this.props.fields.getSelectedField().label))}};V=o["__decorate"]([i["b"]],V);r.d(t,"DashboardContent",function(){return H});const _=a["c"].h1.withConfig({displayName:"Title",componentId:"sc-1umhlaz"})`
    text-align: center;
	color: #357CFF;
	font-size: 36px;
    ...
    font-weight: 300;
    margin: 14px 0 7px 0;
`;const L=a["c"].h2.withConfig({displayName:"SubTitle",componentId:"sc-amg036"})`
    text-align: center;
	color: #273656;
	font-size: 16px;
	font-weight: 300;
	...
	line-height: 19px;
    margin: 7px 0 14px 0;
`;const W=a["c"].div.withConfig({displayName:"DashboardLabel",componentId:"sc-1p6psh"})`
    display: flex;
    height: 48px;
    justify-content: center;
    align-items: center;
`;const O=a["c"].a.withConfig({displayName:"GithubLink",componentId:"sc-ws8mdy"})`
	color: #357CFF;
    opacity: 1;
...
`;let H=class e extends n["Component"]{render(){let{translation:e,clipboard:t}=this.props;let r=this.props.appConfig.getLocale();return n["createElement"](s,null,n["createElement"](_,null,e.get("dashboardView.title")),n["createElement"](L,null,e.get("dashboardView.subTitle"),n["createElement"](O,{href:"https://nepalblockchain.network",target:"_blank"},e.get("dashboardView.github"))),n["createElement"](I["a"],null,n["createElement"](S["a"],{translation:e,search:this.props.search,searchInlineStore:this.props.searchInlineStore})),n["createElement"](W,null,n["createElement"](R["a"],null,e.get("dashboardView.lastBlocksChart.title.label"))),n["createElement"](T,{blockStateStore:this.props.blockStateStore,blockValueStore:this.props.blockValueStore,translation:this.props.translation,logger:this.props.logger}),n["createElement"]("div",{style:{display:"flex",justifyContent:"center",flexWrap:"wrap"}},n["createElement"](B["a"],null,n["createElement"](V,{nodeStore:this.props.nodeStore,fields:this.props.nodeDropdownItems,userPreferences:this.props.userPreferences,translation:e,appConfig:this.props.appConfig})),n["createElement"](B["a"],null,n["createElement"](R["a"],null,e.get("chainView.content.latestBlock.label")),n["createElement"](y["a"],null,this.props.lastBlock.id)),this.props.lastBlock.creationTime?n["createElement"](B["a"],null,n["createElement"](R["a"],null,e.get("blockView.content.blockCreationTime.label")),n["createElement"](M["a"],{timestamp:this.props.lastBlock.creationTime,translation:e,nonclickable:!0,locale:r,clipboard:t})):null,n["createElement"](B["a"],null,n["createElement"](R["a"],null,e.get("blockView.content.transactions.label")),n["createElement"](w["a"],null,this.props.lastBlock.transactions.length)),n["createElement"](B["a"],null,n["createElement"](R["a"],null,e.get("blockView.content.uncles.label")),n["createElement"](D["a"],{locale:r},this.props.lastBlock.uncles.length))))}};H=o["__decorate"]([i["b"]],H)},x56G:function(e,t,r){"use strict";var o=r("D57K");var n=r("ERkP");var i=r("7nmT");var a=r("ETTr");var s=r("l/oz");var l=r("JkUX");var c=r("H8JU");var p=r("H3xX");class h extends n["Component"]{render(){return n["createElement"](p["a"],Object.assign({},this.props),n["createElement"]("g",{stroke:"none",strokeWidth:"1",fill:"none",fillRule:"evenodd"},n["createElement"]("polygon",{points:"0 0 24 0 24 24 0 24"}),n["createElement"]("polygon",{fill:"currentColor",fillRule:"nonzero",points:"14.8284271 16.2426407 12 13.4142136 9.17157288 16.2426407 7.75735931 14.8284271 10.5857864 12 7.75735931 9.17157288 9.17157288 7.75735931 12 10.5857864 14.8284271 7.75735931 16.2426407 9.17157288 13.4142136 12 16.2426407 14.8284271"})))}}const d=a["b"].div`
    cursor: pointer;
    line-height: 1;
...
`;class u extends n["Component"]{render(){return n["createElement"](m,null,n["createElement"]("div",{style:{padding:"4px"}},n["createElement"](d,{onClick:this.props.onClose},n["createElement"](h,null))),this.props.children)}}r.d(t,"a",function(){return f});const g=a["b"].div`
    position: fixed;
    top: 0;
    bottom: 0;
    left: 0;
    right: 0;
`;let f=class e extends n["Component"]{constructor(){super(...arguments);this.isOpened=!1;this.openSelectBox=(()=>{this.isOpened=!0});this.closeSelectBox=(()=>{this.isOpened=!1})}render(){let{disabled:e}=this.props;return n["createElement"](s["a"],null,n["createElement"](s["c"],null,({ref:t})=>n["createElement"]("div",{ref:t,onClick:e?void 0:this.openSelectBox,style:{cursor:e?"default":"pointer"}},this.props.children)),this.isOpened?i["createPortal"](n["createElement"](n["Fragment"],null,n["createElement"](g,{onClick:this.closeSelectBox}),n["createElement"](s["b"],{modifiers:{offset:{offset:this.props.offset?this.props.offset.left+"px, "+this.props.offset.top+"px":"auto"},flip:{enabled:!1},preventOverflow:{enabled:!0},hide:{enabled:!1}},placement:"bottom-start"},({ref:e,placement:t,style:r})=>n["createElement"]("div",{ref:e,"data-placement":t,style:r},n["createElement"](u,{onClose:this.closeSelectBox},this.props.render({requestClose:this.closeSelectBox}))))),document.body):null)}};o["__decorate"]([c["l"]],f.prototype,"isOpened",void 0);f=o["__decorate"]([l["b"]],f)},zPJy:function(e,t,r){"use strict";var o=r("ERkP");var n=r("ETTr");const i=({children:e,className:t})=>o["createElement"]("div",{className:t},e);const a=Object(n["b"])(i)`
    display: flex;
    align-items: center;
...
//# sourceMappingURL=3bb62971f4d0794ce56c.bundle.js.map